...
jib {
    ...
    container {
        ports = listOf("8080")
        jvmFlags = listOf(
            "-javaagent:aws-opentelemetry-agent-1.28.1.jar",
...
application {
    ...
    applicationDefaultJvmArgs = listOf(
        "-javaagent:$buildDir/javaagent/aws-opentelemetry-agent-1.28.1.jar", // Use the Java agent when the application is run
