...
dependencies {
    ...
    implementation("io.opentelemetry.contrib:opentelemetry-aws-xray-propagator:1.33.0-alpha")
    implementation("io.opentelemetry.contrib:opentelemetry-aws-xray:1.33.0")
    ...
    implementation("io.opentelemetry.instrumentation:opentelemetry-okhttp-3.0:2.1.0-alpha")

    implementation(project(":base"))

    constraints {
        implementation("com.fasterxml.jackson:jackson-bom:2.16.2") {
