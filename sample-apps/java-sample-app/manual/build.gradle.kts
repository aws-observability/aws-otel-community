...
dependencies {
    ...
    implementation("io.opentelemetry.contrib:opentelemetry-aws-xray-propagator:1.25.1-alpha")
    implementation("io.opentelemetry.contrib:opentelemetry-aws-xray:1.25.1")
