...
dependencies {
    ...
    implementation("io.opentelemetry.contrib:opentelemetry-aws-xray:1.43.0")
    ...
    implementation("io.opentelemetry.instrumentation:opentelemetry-okhttp-3.0:2.13.0-alpha")
