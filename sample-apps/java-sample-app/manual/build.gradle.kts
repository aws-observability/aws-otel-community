...
dependencies {
    ...
    implementation("io.opentelemetry.contrib:opentelemetry-aws-xray-propagator:1.27.0-alpha")
    ...
    implementation("io.opentelemetry.instrumentation:opentelemetry-okhttp-3.0:1.27.0-alpha")
